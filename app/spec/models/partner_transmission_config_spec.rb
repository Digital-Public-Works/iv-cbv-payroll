  ...
  describe "#value encryption logic" do
    context "when encrypted is true" do
      it "encrypts the data in the database" do
        ptc = PartnerTransmissionConfig.create!(key: "demo-config-item", is_encrypted: true, value: cleartext, partner_config: PartnerConfig.last)
    ...
    context "when encrypted is false" do
      it "stores the data as plain text" do
        ptc = PartnerTransmissionConfig.create!(key: "demo-config-item", is_encrypted: false, value: cleartext, partner_config: PartnerConfig.last)
